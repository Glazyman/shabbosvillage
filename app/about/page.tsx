          ...
          <div style={{ paddingTop: "12px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
              {[
                ...
                { title: "Food storage station", desc: "A shared space with warmers and freezers where tent campers store all food. Everything is locked in securely overnight." },
                { title: "6 minyonim within walking distance", desc: "A variety of six minyanim are within easy walking distance of the campground — and you're always welcome to make your own minyan as well." },
              ].map((item, i) => (
